...
print(hamlet_dict_no_punct.most_common(15))
...
print(hamlet_dict_no_stop_word.most_common(15))
...
#
# hamlet_dict_no_stop_word.plot(20)
# plt.tight_layout()

#Text Objects
hamlet_t = Text(hamlet_w)
# print(type(hamlet_t))
hamlet_t.concordance('Ham', lines=5)
